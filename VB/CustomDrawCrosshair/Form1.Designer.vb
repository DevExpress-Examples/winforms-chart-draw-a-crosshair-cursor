...
Namespace CustomDrawCrosshair
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Dim pointOptions3 As New DevExpress.XtraCharts.PointOptions()
			Dim splineSeriesView3 As New DevExpress.XtraCharts.SplineSeriesView()
			...
			' chartControl1
			' 
			Me.chartControl1.CrosshairOptions.ArgumentLineColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(222))))), (CInt(Fix((CByte(57))))), (CInt(Fix((CByte(205))))))
			...
			Me.chartControl1.CrosshairOptions.ValueLineColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(222))))), (CInt(Fix((CByte(57))))), (CInt(Fix((CByte(205))))))
